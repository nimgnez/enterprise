    ...
    <div style="height:auto!important;height:550px;min-height:550px;">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="10" class="tableBasic">
            ...
            <tr>
                ...
                <td style="text-align: left;"><input type="text" size="40" value="${e.name}" name="name"
                                                     data-rule="名称:required;name;length[1~45];"
                                                     id="name"/></td>
            </tr>
            <tr>
                <th style="text-align: right;">地址</th>
                <td style="text-align: left;"><input type="text" size="40" value="${e.url}" name="url"
                                                     data-rule="地址:required;url;length[1~70];"
                                                     id="url"/><br>
                </td>
            </tr>
            <tr>
                    ...
                    <select name="target">
                        <c:forEach var="entry" items="<%=targets %>">
                            <option value="${entry.key}"
                                    <c:if test="${e.target eq entry.key }">selected="selected"</c:if> >${entry.value}</option>
                        </c:forEach>
                    </select>
                </td>
            </tr>
