    ...
    <body>
        ...
        <div id="login">
            ...
            <form action="<%=path %>/manage/user/login" method="post">
                <div style="heigth: 44px;line-height: 44px;font-size:22px;text-align: center;"><%=SystemManage.getInstance().getSystemSetting().getName() %>
                    后台管理系统
                </div>
                ...
                <ul>
                    ...
                    <li class="inpLi"><b>密码：</b><input type="password" name="password" id="password" class="inpLogin"
                                                       value="123456"
                                                       placeholder="密码"/></li>
                    <li class="captchaPic">
                        <div class="inpLi" style="overflow: hidden;width: 236px;float: left;"><b>验证码：</b><input
                                name="manage_vcode" type="text" class="captcha"></div>
                    ...
                    <li class="sub"><input type="checkbox" class="ace" name="remember" value="true">下次自动登录 <input
                            type="submit" name="submit" class="btn" value="登录"></li>
