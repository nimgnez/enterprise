...
!function (window, undefined) {
    ...
    function _getInitHtml(a, b, c, d) {
        var e = ["" === _direction ? "<html>" : '<html dir="' + _direction + '">', '<head><meta charset="utf-8" /><title></title>', "<style>", "html {margin:0;padding:0;}", "body {margin:0;padding:5px;}", 'body, td {font:12px/1.5 "sans serif",tahoma,verdana,helvetica;}', "body, p, div {word-wrap: break-word;}", "p {margin:5px 0;}", "table {border-collapse:collapse;}", "img {border:0;}", "noscript {display:none;}", "table.ke-zeroborder td {border:1px dotted #AAA;}", "img.ke-flash {", "	border:1px solid #AAA;", "	background-image:url(" + a + "entity/flash.gif);", "	background-position:center center;", "	background-repeat:no-repeat;", "	width:100px;", "	height:100px;", "}", "img.ke-rm {", "	border:1px solid #AAA;", "	background-image:url(" + a + "entity/rm.gif);", "	background-position:center center;", "	background-repeat:no-repeat;", "	width:100px;", "	height:100px;", "}", "img.ke-media {", "	border:1px solid #AAA;", "	background-image:url(" + a + "entity/media.gif);", "	background-position:center center;", "	background-repeat:no-repeat;", "	width:100px;", "	height:100px;", "}", "img.ke-anchor {", "	border:1px dashed #666;", "	width:16px;", "	height:16px;", "}", ".ke-script, .ke-noscript, .ke-display-none {", "	display:none;", "	font-size:0;", "	width:0;", "	height:0;", "}", ".ke-pagebreak {", "	border:1px dotted #AAA;", "	font-size:0;", "	height:2px;", "}", "</style>"];
    ...
    function _createButton(a) {
        a = a || {};
        var b = a.name || "", c = K('<span class="ke-button-entity ke-button-outer" title="' + b + '"></span>'),
            d = K('<input class="ke-button-entity ke-button" type="button" value="' + b + '" />');
    ...
    if (!window.KindEditor) {
        ...
        (html = document.getElementsByTagName("html")) && (_direction = html[0].dir), _extend(KEdit, KWidget, {
            ...
            init: function (a) {
                ...
                var n = a.width || K(".ke-button-entity", m).width();
        ...
        KEditor.prototype = {
            ...
            _each("undo,redo".split(","), function (a, d) {
                ...
                return _IE && 8 >= _V && (a = a.replace(/<input[^>]*>|<(select|button)[^>]*>[\s\S]*?<\/\1>/gi, function (a) {
                    ...
                    return c.src = _undef(c.src, ""), c.width = _undef(c.width, 0), c.height = _undef(c.height, 0), _mediaImg(b.themesPath + "entity/blank.gif", c)
                }).replace(/<a[^>]*name="([^"]+)"[^>]*>(?:<\/a>)?/gi, function (a) {
                    var c = _getAttrList(a);
                    return c.href !== undefined ? a : '<img class="ke-anchor" src="' + b.themesPath + 'entity/anchor.gif" data-ke-name="' + escape(c.name) + '" />'
                ...
                l = b.createDialog({
                    ...
                    yesBtn: {
                        name: b.lang("yes"), click: function () {
                            ...
                            var f = a.mediaImg(b.themesPath + "entity/blank.gif", {
                                src: c,
